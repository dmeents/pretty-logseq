...
export const settingsSchema: SettingSchemaDesc[] = [
  ...
  },
  {
    ...
    description:
      "Show custom hover previews for page references with page properties.",
    type: "boolean",
    default: true,
  },
  {
  ...
  },
  {
    ...
    description:
      "Display navigation items as inline icons instead of a vertical list.",
    type: "boolean",
    default: true,
  },
  {
  ...
  },
  {
    ...
    description:
      "Move the graph/vault selection menu to the bottom of the sidebar.",
    type: "boolean",
    default: false,
  },
  {
  ...
  },
  {
    ...
    description:
      "Hide the sync/cloud status indicator from the top navigation bar.",
    type: "boolean",
    default: false,
  },
  {
